			...
			<div id="sidebar" class="sidebar sidebar-with-footer">
				...
				<div class="sidebar-left" data-simplebar style="height: 100%;">
					...
					<ul class="nav sidebar-inner" id="sidebar-menu">
						...
						<li>
							<a class="sidenav-item-link" href="#"> <i class="mdi mdi-settings"></i> <span class="nav-text">Categories</span> </a>
						</li>
						<li>
...
<footer class="footer mt-auto">
				<div class="copyright bg-white">
					<p> &copy; <span id="copy-year"></span> Design Developed by <a class="text-primary" href="http://hasnain-mawia.web.app/" target="_blank">Hasnain Mawia</a>. </p>
				</div>
				<script>
				var d = new Date();
